...
class CSwin(nn.Module):
    ...
    def __init__(self, nclass, img_size, embed_dim, depth, num_heads, split_size, drop_path_rate,
                 head_dim, aux=False, pretrained_root=None, head='seghead', edge_aux=False, in_chans=3):
        super(CSwin, self).__init__()
        self.aux = aux
        self.edge_aux = edge_aux
        self.head_name = head
        self.head_dim = head_dim
        self.backbone = CSWin(img_size=img_size, in_chans=in_chans, embed_dim=embed_dim, drop_path_rate=drop_path_rate,
...
def cswin_tiny_2band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_tiny_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[1, 2, 21, 1], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.3, in_chans=2)
    return model


def cswin_small_2band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_small_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[2, 4, 32, 2], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.4, in_chans=2)
    return model


def cswin_base_2band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_base_384.pth'
        # pretrained_root = './pretrained_weights/cswin_base_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=96, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[4, 8, 16, 32], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[96, 192, 384, 768], drop_path_rate=0.6, in_chans=2)
    return model


def cswin_large_2band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_large_384.pth'
        # pretrained_root = './pretrained_weights/cswin_large_22k_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=144, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[6, 12, 24, 48], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[144, 288, 576, 1152], drop_path_rate=0.6, in_chans=2)
    return model


def cswin_tiny_6band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_tiny_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[1, 2, 21, 1], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.3, in_chans=6)  # 将 in_chans 改为 6
    return model


def cswin_small_6band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_small_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[2, 4, 32, 2], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.4, in_chans=6)  # 将 in_chans 改为 6
    return model


def cswin_base_6band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_base_384.pth'
        # pretrained_root = './pretrained_weights/cswin_base_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=96, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[4, 8, 16, 32], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[96, 192, 384, 768], drop_path_rate=0.6, in_chans=6)  # 将 in_chans 改为 6
    return model


def cswin_large_6band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_large_384.pth'
        # pretrained_root = './pretrained_weights/cswin_large_22k_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=144, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[6, 12, 24, 48], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[144, 288, 576, 1152], drop_path_rate=0.6, in_chans=6)  # 将 in_chans 改为 6
    return model


def cswin_tiny_8band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_tiny_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[1, 2, 21, 1], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.3, in_chans=8)  # 将 in_chans 改为 8
    return model


def cswin_small_8band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_small_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[2, 4, 32, 2], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.4, in_chans=8)  # 将 in_chans 改为 8
    return model


def cswin_base_8band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_base_384.pth'
        # pretrained_root = './pretrained_weights/cswin_base_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=96, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[4, 8, 16, 32], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[96, 192, 384, 768], drop_path_rate=0.6, in_chans=8)  # 将 in_chans 改为 8
    return model


def cswin_large_8band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_large_384.pth'
        # pretrained_root = './pretrained_weights/cswin_large_22k_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=144, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[6, 12, 24, 48], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[144, 288, 576, 1152], drop_path_rate=0.6, in_chans=8)  # 将 in_chans 改为 8
    return model


def cswin_tiny_9band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_tiny_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[1, 2, 21, 1], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.3, in_chans=9)  # 将 in_chans 改为 9
    return model


def cswin_small_9band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_small_224.pth'
    else:
        pretrained_root = None
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=64, depth=[2, 4, 32, 2], split_size=[1, 2, 7, 7],
                  num_heads=[2, 4, 8, 16], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[64, 128, 256, 512], drop_path_rate=0.4, in_chans=9)  # 将 in_chans 改为 9
    return model


def cswin_base_9band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_base_384.pth'
        # pretrained_root = './pretrained_weights/cswin_base_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=96, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[4, 8, 16, 32], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[96, 192, 384, 768], drop_path_rate=0.6, in_chans=9)  # 将 in_chans 改为 9
    return model


def cswin_large_9band(nclass, img_size, pretrained=False, aux=False, head='uperhead', edge_aux=False):
    if pretrained:
        pretrained_root = './pretrained_weights/cswin_large_384.pth'
        # pretrained_root = './pretrained_weights/cswin_large_22k_224.pth'
    else:
    ...
    model = CSwin(nclass=nclass, img_size=img_size, embed_dim=144, depth=[2, 4, 32, 2], split_size=[1, 2, 12, 12],
                  num_heads=[6, 12, 24, 48], aux=aux, head=head, edge_aux=edge_aux, pretrained_root=pretrained_root,
                  head_dim=[144, 288, 576, 1152], drop_path_rate=0.6, in_chans=9)  # 将 in_chans 改为 9
    return model


# ===== 通用构建器 for CSWin Tiny/Small/Base/Large ===== #

def cswin_tiny_nband(nclass, in_chans=3, pretrained=False, aux=False, head='uperhead', edge_aux=False, img_size=224):
    pretrained_root = './pretrained_weights/cswin_tiny_224.pth' if pretrained else None
    model = CSwin(
        nclass=None,  # DualHead 中不需设分类数
        img_size=img_size,
        embed_dim=64,
        depth=[1, 2, 21, 1],
        split_size=[1, 2, 7, 7],
        ...
        drop_path_rate=0.3,
        in_chans=in_chans   # ✅ 支持动态输入通道
    )
    return model


def cswin_small_nband(nclass, in_chans=3, pretrained=False, aux=False, head='uperhead', edge_aux=False, img_size=224):
    pretrained_root = './pretrained_weights/cswin_small_224.pth' if pretrained else None
    model = CSwin(
        nclass=None,
        img_size=img_size,
        embed_dim=64,
...
def cswin_base_nband(nclass, in_chans=3, pretrained=False, aux=False, head='uperhead', edge_aux=False, img_size=384):
    pretrained_root = './pretrained_weights/cswin_base_384.pth' if pretrained else None
    model = CSwin(
        nclass=None,
        img_size=img_size,
        embed_dim=96,
...
def cswin_large_nband(nclass, in_chans=3, pretrained=False, aux=False, head='uperhead', edge_aux=False, img_size=384):
    pretrained_root = './pretrained_weights/cswin_large_384.pth' if pretrained else None
    model = CSwin(
        nclass=None,
        img_size=img_size,
        embed_dim=144,
...
CSWIN_VARIANTS = {
    'cswin_tiny': cswin_tiny_nband,
    'cswin_small': cswin_small_nband,
    'cswin_base': cswin_base_nband,
    'cswin_large': cswin_large_nband
}
