...
stage1_options = {
    ...
    # --网络设置-- #
    'backbone': 'resnet18',        # 'resnet18', 'resnet34', 'efficientnet-b0', etc.
    'encoder_weights': 'imagenet',# 'imagenet' 或 None（无预训练）
    
    'net_mode': 'sic_only', # 第一阶段为sic_only
    
    'depth': 4,  # 深度
    'shrink_ratio': 2,  # 解码器缩放倍数 
...
stage2_options.update({
    ...
    'use_cnn_iw_head': True,  # 是否对IW使用CNN辅助头
    'use_trans_iw_head': True,  # 是否对IW使用Transformer辅助头
    ...
    # 'labels': LABELS_ST2_SIC,  # sic
    # 'labels': LABELS_ST2_IW,  # iw
