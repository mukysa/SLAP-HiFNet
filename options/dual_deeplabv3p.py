...
stage1_options = {
    ...
    # --网络设置-- #
    # Swin（both）, swin_tiny, swin_small
    'backbone': 'resnet50',      # 对应你现在写的 MobileNetV2'mobilenet','resnet50'
    'downsample_factor': 8,       # DeepLab 常见 8 或 16，配 ASPP 里 rate=16//factor
    'pretrained': True,
