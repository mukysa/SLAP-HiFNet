...
stage1_options = {
    ...
    # --网络设置-- #
    # UNet 编码器（SAR）
    'sar_encoder': 'resnet50',           # 或 'resnet50' 等
    'sar_encoder_weights': 'imagenet',   # SAR 是 3 通道，可以用 'imagenet'。若不是3通道请设 None

    # UNet 编码器（AMSR2）
    'amsr_encoder': 'resnet50',           # 或 'resnet50' 等
    'amsr_encoder_weights': 'imagenet',   # SAR 是 3 通道，可以用 'imagenet'。若不是3通道请设 None
